...
app.use('/friendConnect',require('./routes/friendConnect.js'));
app.use('/contacts',require('./routes/contacts.js'));
app.use('/code_to_email',require('./routes/utilities/code_to_email.js'));
app.use('/update_password',require('./routes/utilities/update_password.js'));
